...
namespace WindowsAutomation
{
	...
	public class UI
	{
		...
		public static void Window_SetWindowTextRaw( int hwnd, string desired_text )
		{

			win32.SendMessage(hwnd, (int) win32.constants.WM_SETTEXT, 0, desired_text);

		}
		public static string GetWindowTextRaw( int hwnd )
		{
		...
		public static void MouseClickLeftButton( int hwnd )
		{
		...
		public static int GetChild( int hwnd, string wind_class, string wind_text )
		{
			return GetChildEx( hwnd, 0, wind_class, wind_text, null , 0);
		}

		public static int GetChildEx( int hwnd, int owner_id, string wind_class, string wind_text, string wind_text_raw, int control_id )
		{
		...
		public static void LeftClick( int hwnd )
		{
			WindowsAutomation.UI.MouseClickLeftButton( hwnd );
		...
		public static void Menu_Select( int hwnd, string m1, string m2 )
		{
			...
			if ( mi == null)
			{
				throw new Errors.AutomationError( string.Format( "Couldn't find {0} {1}",m1,m2 ) );
			}
			Tracing.WriteLine( "Menu_Select menu id = {0}", mi.id );

			win32.SendMessage(  hwnd, (int) win32.constants.WM_COMMAND,  mi.id, 0 );
	...
	class TestWindowText: WindowsAutomation.Timing.IWaitClient
	{
		...
		{
			return( this.m_text == WindowsAutomation.UI.GetWindowTextRaw( this.m_hwnd ) );
		}
