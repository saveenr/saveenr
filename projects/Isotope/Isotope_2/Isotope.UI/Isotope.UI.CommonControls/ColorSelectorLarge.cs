...
namespace Isotope.UI.CommonControls
{
    public partial class ColorSelectorLarge : UserControl
    {
        ...
        public ColorSelectorLarge()
        {
            ...
            bmp_hue = bmp_hue ?? UIUtil.create_hue_bitmap2(this.pictureBoxHue.Width, this.pictureBoxHue.Height);
        ...
        private void handle_hue_click(System.Drawing.Point hue_click)
        {
            ...
            Isotope.UI.CommonControls.ColorUtil.RGBToHSV(this.Color,out _h, out _s, out _v);
        ...
        private System.Drawing.Drawing2D.LinearGradientBrush GetLightnessBrush()
        {
        ...
        private System.Drawing.Drawing2D.LinearGradientBrush GetHueBrush()
        {
            ...
            var right_color = Isotope.UI.CommonControls.ColorUtil.HSVToSystemDrawingColor(_hue,_sat,_val);
            var rect = this.GetGradientRect();
        ...
        private void Gradient_Paint(System.Drawing.Graphics gfx)
        {
            ...
            using (var lightness_brush = this.GetLightnessBrush())
            using (var hue_brush = this.GetHueBrush())
            {
                // draw the hsv gradient
                gfx.FillRectangle(lightness_brush, gradient_rect);
